...
X = numX[:,2:4]
#X = np.concatenate((X,numX[:,2].reshape(numX.shape[0],1)),axis=1)
#X = np.concatenate((X,numX[:,3:4]),axis=1)
...
for i in range(5):
# =============================================================================
#     lr = linearRegression(np.array([0]*22))
# =============================================================================
    trainX,trainY,valX,valY = splitData(cvX,cvY,idx,i)
# =============================================================================
#     trainErr = lr.train(trainX,trainY,0.3e-7,30000)
